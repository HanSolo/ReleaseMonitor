...
public struct Constants {
    ...
    public static let DISCO_LATEST_VERSION_URL            : String          = "\(DISCO_API_BASE_URL)distributions/versions/latest?distribution=bisheng,corretto,dragonwell,graalvm,graalvm_community,liberica,liberica_native,microsoft,openlogic,oracle_open_jdk,oracle,sap_machine,semeru,semeru_certified,temurin,zulu&include_ea=true"
    ...
    public static var UPDATES                             : [String:Update] = ["corretto"          : Update.init(distribution: Distribution(uiString: "Corretto",     apiString: "coretto",           latestGA: nil, latestEA: nil), lastUpdateLatestGA: INITIAL_DATE_TIME, lastUpdateLatestEA: INITIAL_DATE_TIME),
                                                                               "graalvm"           : Update.init(distribution: Distribution(uiString: "GraalVM",      apiString: "graalvm",           latestGA: nil, latestEA: nil), lastUpdateLatestGA: INITIAL_DATE_TIME, lastUpdateLatestEA: INITIAL_DATE_TIME),
                                                                               ...
                                                                               "semeru_certified"  : Update.init(distribution: Distribution(uiString: "Semeru Cert.", apiString: "semeru_certified",  latestGA: nil, latestEA: nil), lastUpdateLatestGA: INITIAL_DATE_TIME, lastUpdateLatestEA: INITIAL_DATE_TIME),
